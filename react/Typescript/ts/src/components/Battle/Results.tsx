...
const Results: FC = (): ReactElement => {
  ...
  return (
    <div>
      {loading ? (
        <div className="cube-pos" style={{ margin: "25% 25%" }}>
          <div className="cube">
              ...
              <div className="list">
                <ul className="space-list-item">
                  ...
                  <li>
                    Blog:{" "}
                    {winner.profile.blog ? (
                      <a href={winner.profile.blog} target="_blank" rel="noreferrer">
                        {winner.profile.blog}
                      </a>
                    ) : (
                      <span>no information</span>
              ...
              <div className="list">
                <ul className="space-list-item">
                  ...
                  <li>
                    Blog:{" "}
                    {loser.profile.blog ? (
                      <a href={loser.profile.blog} target="_blank" rel="noreferrer">
                        {loser.profile.blog}
                      </a>
                    ) : (
                      <span>no information</span>
